...
<head>
    ...
    <title>Capture & Annotate Ads in One Click—Install Our Extension</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">Ready to supercharge your ad research? Our browser extension makes it incredibly easy to capture and analyze competitor ads on any website.</p>
                            <p style="font-size:18px;font-weight:600;margin-bottom:16px;color:#111827;">What the extension does:</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin:0;padding-left:20px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;"><b>One-click capture</b> of any web page or ad</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;"><b>Instant annotations</b> with notes &amp; highlights</td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;color:#374151;"><b>Direct sync</b> to your Flonnect projects</td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fef3c7;padding:16px;border-radius:8px;margin:24px 0;">
                                <tr>
                                    <td>
                                        <p style="font-size:16px;color:#92400e;margin:0;text-align:center;"><b>⚡ Pro tip:</b> Use it while browsing social media ads for instant competitive intelligence!</p>
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display:inline-block;background-color:#16a34a;color:#fff;padding:16px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;">🔗 Install Extension</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;">Available for Chrome, Firefox, and Safari. Installation takes less than 30 seconds!</p>
...
Ready to supercharge your ad research? Our browser extension makes it incredibly easy to capture and analyze competitor ads on any website.

What the extension does:
• One-click capture of any web page or ad
• Instant annotations with notes & highlights
• Direct sync to your Flonnect projects

⚡ Pro tip: Use it while browsing social media ads for instant competitive intelligence!

Install Extension: [Link]

Available for Chrome, Firefox, and Safari. Installation takes less than 30 seconds!
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="bg-white rounded-xl shadow-lg max-w-2xl mx-auto overflow-hidden" style={{ fontFamily: 'Arial, sans-serif' }}>
                    ...
                    <div id="email-content" className="p-8 space-y-6">
                      ...
                      <div>
                        <p className="text-lg font-semibold text-gray-900 mb-4">What the extension does:</p>
                        <ul className="space-y-2 text-gray-700 pl-4">
                          <li><strong>One-click capture</strong> of any web page or ad</li>
                          <li><strong>Instant annotations</strong> with notes & highlights</li>
                          <li><strong>Direct sync</strong> to your Flonnect projects</li>
                        </ul>
                      </div>

                      <div className="bg-yellow-50 p-4 rounded-lg text-center">
                        <p className="text-yellow-800 font-medium">
                          <strong>⚡ Pro tip:</strong> Use it while browsing social media ads for instant competitive intelligence!
                        </p>
                      </div>
