...
import { ArrowLeft, Mail, MessageCircle, Copy, Send } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useToast } from '@/hooks/use-toast';

export default function FeedbackCheckinEmailPage() {
  ...
  const generateAWSSESTemplate = () => {
    const sesTemplate = {
      TemplateName: "flonnect-feedback-checkin",
...
<head>
    ...
    <title>How's It Going with Flonnect? We'd Love Your Feedback</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">It's been three weeks since you joined Flonnect! We hope you're finding it useful for your {{CompanyName}} team.</p>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">Your feedback helps us build a better product, so we'd love to hear from you:</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin:0;padding-left:20px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;">What's working well for your team?</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;">What features would you like to see improved?</td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;color:#374151;">Any roadblocks we can help remove?</td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f0f9ff;padding:16px;border-radius:8px;margin:24px 0;">
                                <tr>
                                    <td>
                                        <p style="font-size:16px;color:#1e40af;margin:0;text-align:center;"><b>💡 Bonus:</b> Share feedback and get early access to our upcoming AI-powered insights feature!</p>
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display:inline-block;background-color:#16a34a;color:#fff;padding:16px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;">💬 Share Feedback</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;">Takes less than 2 minutes, and every response gets read by our product team.</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:32px;padding-top:24px;border-top:1px solid #e5e7eb;">
                                <tr>
                                    <td>
                                        <p style="font-size:16px;color:#374151;">Thanks for being awesome!<br>The Flonnect Team</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
It's been three weeks since you joined Flonnect! We hope you're finding it useful for your {{CompanyName}} team.

Your feedback helps us build a better product, so we'd love to hear from you:
• What's working well for your team?
• What features would you like to see improved?
• Any roadblocks we can help remove?

💡 Bonus: Share feedback and get early access to our upcoming AI-powered insights feature!

Share Feedback: [Link]

Takes less than 2 minutes, and every response gets read by our product team.
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900">Check-In & Feedback</h1>
                </div>
                <p className="text-gray-600 mt-1">Trigger: 21 days after Step 1 | Delay: 21 days after Step 1</p>
              </div>
            </div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg max-w-2xl mx-auto overflow-hidden" style={{ fontFamily: 'Arial, sans-serif' }}>
                    ...
                    <div id="email-content" className="p-8 space-y-6">
                      ...
                      <ul className="space-y-2 text-gray-700 pl-4">
                        <li>• What's working well for your team?</li>
                        <li>• What features would you like to see improved?</li>
                        <li>• Any roadblocks we can help remove?</li>
                      </ul>

                      <div className="bg-blue-50 p-4 rounded-lg text-center">
                        <p className="text-blue-800 font-medium">
                          <strong>💡 Bonus:</strong> Share feedback and get early access to our upcoming AI-powered insights feature!
                        </p>
                      </div>
                      ...
                      <div className="pt-6 border-t border-gray-200">
                        <p className="text-gray-700">Thanks for being awesome!<br />The Flonnect Team</p>
                      </div>
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800">21 days after Step 1</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800">Share Feedback</p>
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-mono">flonnect-feedback-checkin</p>
                </div>
                <div>
