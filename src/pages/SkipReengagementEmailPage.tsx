...
import { ArrowLeft, Mail, MessageSquare, Copy, Send } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useToast } from '@/hooks/use-toast';

export default function SkipReengagementEmailPage() {
  ...
  const generateAWSSESTemplate = () => {
    const sesTemplate = {
      TemplateName: "flonnect-skip-reengagement",
...
<head>
    ...
    <title>Need a Hand Getting Started?</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">We noticed you skipped a setup step—no worries! Getting started with a new tool can feel overwhelming.</p>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">We're here to help you get the most out of Flonnect. Whether you need a quick walkthrough or have specific questions, we've got you covered.</p>
                            <p style="font-size:18px;font-weight:600;margin-bottom:16px;color:#111827;">How can we help?</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin:0;padding-left:20px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;">Chat with our support team for instant help</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;">Book a personalized demo session</td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;color:#374151;">Browse our knowledge base &amp; tutorials</td>
                                </tr>
                            </table>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding:0 8px 12px;">
                                                    <a href="#" style="display:inline-block;background-color:#2563eb;color:#fff;padding:16px 24px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;min-width:180px;text-align:center;">💬 Chat with Support</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:0 8px 12px;">
                                                    <a href="#" style="display:inline-block;background-color:#16a34a;color:#fff;padding:16px 24px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;min-width:180px;text-align:center;">📅 Book a Demo</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;">No pressure—we're just here when you're ready to dive in!</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:32px;padding-top:24px;border-top:1px solid #e5e7eb;">
                                <tr>
                                    <td>
                                        <p style="font-size:16px;color:#374151;">Here to help,<br>The Flonnect Team</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
We noticed you skipped a setup step—no worries! Getting started with a new tool can feel overwhelming.

We're here to help you get the most out of Flonnect. Whether you need a quick walkthrough or have specific questions, we've got you covered.

How can we help?
• Chat with our support team for instant help
• Book a personalized demo session
• Browse our knowledge base & tutorials

Chat with Support: [Link]
Book a Demo: [Link]

No pressure—we're just here when you're ready to dive in!
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900">Skip-Flow Re-Engagement</h1>
                </div>
                <p className="text-gray-600 mt-1">Trigger: User clicks any "Skip" link | Delay: Immediately on skip</p>
              </div>
            </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="bg-white rounded-xl shadow-lg max-w-2xl mx-auto overflow-hidden" style={{ fontFamily: 'Arial, sans-serif' }}>
                    ...
                    <div id="email-content" className="p-8 space-y-6">
                      ...
                      <div>
                        <p className="text-lg font-semibold text-gray-900 mb-4">How can we help?</p>
                        <ul className="space-y-2 text-gray-700 pl-4">
                          <li>• Chat with our support team for instant help</li>
                          <li>• Book a personalized demo session</li>
                          <li>• Browse our knowledge base & tutorials</li>
                        </ul>
                      </div>
                      ...
                      <div className="pt-6 border-t border-gray-200">
                        <p className="text-gray-700">Here to help,<br />The Flonnect Team</p>
                      </div>
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800">User clicks any "Skip" link</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">Send Delay</p>
                  <p className="text-sm text-gray-800">Immediately on skip</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">Primary CTA</p>
                  <p className="text-sm text-gray-800">Chat with Support / Book a Demo</p>
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-mono">flonnect-skip-reengagement</p>
                </div>
                <div>
