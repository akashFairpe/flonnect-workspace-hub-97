...
import { ArrowLeft, Mail, CheckCircle, Copy, Send } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useToast } from '@/hooks/use-toast';

export default function TaskCompletedEmailPage() {
  ...
  const generateAWSSESTemplate = () => {
    const sesTemplate = {
      TemplateName: "flonnect-task-completed",
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">Congrats—"{{TaskTitle}}" in "{{ProjectName}}" has been marked Completed by {{CompleterName}} on {{CompletionDate}}.</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="margin:0;padding-left:20px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;">Review deliverables</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:8px;font-size:16px;color:#374151;">Close out any final comments or attachments.</td>
                                </tr>
                                <tr>
                                    <td style="font-size:16px;color:#374151;">Celebrate your win! 🎉</td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display:inline-block;background-color:#16a34a;color:#fff;padding:16px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;">🔗 View Task</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;">Thanks for keeping the project moving. If you see anything to tweak, you can always reopen the task or leave a comment.</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:32px;padding-top:24px;border-top:1px solid #e5e7eb;">
                                <tr>
                                    <td>
                                        <p style="font-size:16px;color:#374151;">All the best,<br>The Flonnect Team</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
Congrats—"{{TaskTitle}}" in "{{ProjectName}}" has been marked Completed by {{CompleterName}} on {{CompletionDate}}.

What's next?
• Review deliverables
• Close out any final comments or attachments.
• Celebrate your win! 🎉

View Task: [Link]

Thanks for keeping the project moving. If you see anything to tweak, you can always reopen the task or leave a comment.
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <Badge variant="outline">Task Completion</Badge>
                  <h1 className="text-2xl font-bold text-gray-900">Task Completed</h1>
                </div>
                <p className="text-gray-600 mt-1">Trigger: Task marked as completed | Delay: Immediately</p>
              </div>
            </div>
                    ...
                    <div id="email-content" className="p-8 space-y-6">
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-gray-700 pl-4">
                          ...
                          <li>• Close out any final comments or attachments.</li>
                          <li>• Celebrate your win! 🎉</li>
                        </ul>
                      </div>
                      ...
                      <div className="pt-6 border-t border-gray-200">
                        <p className="text-gray-700">All the best,<br />The Flonnect Team</p>
                      </div>
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800">Task marked as completed</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800">View Task</p>
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-mono">flonnect-task-completed</p>
                </div>
                <div>
