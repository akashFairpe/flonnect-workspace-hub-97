...
import { ArrowLeft, Mail, CheckSquare, Copy, Send } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useToast } from '@/hooks/use-toast';

export default function TaskAssignmentEmailPage() {
  ...
  const generateAWSSESTemplate = () => {
    const sesTemplate = {
      TemplateName: "flonnect-task-assignment",
...
<head>
    ...
    <title>New Task Assigned to You: "{{TaskTitle}}"</title>
</head>
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f8fafc;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f8fafc;">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:18px;margin-bottom:24px;color:#111827;">Hi {{AssigneeFirstName}},</p>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">A new {{TaskType}} has been assigned to you in "{{ProjectName}}":</p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;background-color:#f8fafc;border:1px solid #e5e7eb;border-radius:8px;padding:16px;">
                                <tr>
                                    <td>
                                        <p style="font-size:18px;font-weight:600;margin-bottom:8px;color:#111827;">{{TaskTitle}}</p>
                                        <p style="font-size:14px;margin-bottom:4px;color:#6b7280;">Priority: <span style="font-weight:600;">{{Priority}}</span></p>
                                        <p style="font-size:14px;margin:0;color:#6b7280;">Due: <span style="font-weight:600;">{{DueDate}}</span></p>
                                    </td>
                                </tr>
                            </table>
                            <p style="font-size:18px;font-weight:600;margin-bottom:16px;color:#111827;">Details & Next Steps</p>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;line-height:1.6;">{{TaskDescription}}</p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="#" style="display:inline-block;background-color:#2563eb;color:#fff;padding:16px 32px;border-radius:8px;text-decoration:none;font-weight:600;font-size:16px;">🔗 View Task in Flonnect</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="font-size:16px;margin-bottom:24px;color:#374151;">If you need to adjust timelines or have questions, please reply to this email or comment directly on the task.</p>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:32px;padding-top:24px;border-top:1px solid #e5e7eb;">
                                <tr>
                                    <td>
                                        <p style="font-size:16px;color:#374151;">Thanks,<br>The Flonnect Team</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="background-color:#f8fafc;padding:24px 32px;font-size:12px;color:#6b7280;text-align:center;line-height:1.5;">
                            ...
                            <p style="margin-bottom:8px;">You're receiving this because a task was assigned to you.</p>
                            <p style="margin:0;">
      ...
      TextPart: `Hi {{AssigneeFirstName}},

A new {{TaskType}} has been assigned to you in "{{ProjectName}}":
...
View Task in Flonnect: [Link]

If you need to adjust timelines or have questions, please reply to this email or comment directly on the task.
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Trigger: Task assigned to user | Delay: Immediately</p>
              </div>
            </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="bg-white rounded-xl shadow-lg max-w-2xl mx-auto overflow-hidden" style={{ fontFamily: 'Arial, sans-serif' }}>
                    ...
                    <div id="email-content" className="p-8 space-y-6">
                      <p className="text-lg text-gray-900">Hi {'{{AssigneeFirstName}}'},</p>
                      ...
                      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        <p className="text-lg font-semibold text-gray-900 mb-2">{'{{TaskTitle}}'}</p>
                        <p className="text-sm text-gray-600 mb-1">Priority: <span className="font-semibold">{'{{Priority}}'}</span></p>
                        <p className="text-sm text-gray-600">Due: <span className="font-semibold">{'{{DueDate}}'}</span></p>
                      </div>

                      <div>
                        <p className="text-lg font-semibold text-gray-900 mb-4">Details & Next Steps</p>
                      ...
                      <div className="pt-6 border-t border-gray-200">
                        <p className="text-gray-700">Thanks,<br />The Flonnect Team</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 px-8 py-6 text-xs text-gray-500 text-center leading-relaxed">
                      ...
                      <p className="mb-2">You're receiving this because a task was assigned to you.</p>
                      <p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800">Task assigned to user</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-800">View Task in Flonnect</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-600">Variables</p>
                  <div className="text-sm text-gray-800 space-y-1">
                    <p>{'{{AssigneeFirstName}}'}</p>
                    <p>{'{{TaskType}}'}</p>
                    <p>{'{{TaskTitle}}'}</p>
                    <p>{'{{ProjectName}}'}</p>
                    <p>{'{{Priority}}'}</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-800 font-mono">flonnect-task-assignment</p>
                </div>
                <div>
